...
<body id="page-top" onload="initClock()">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Sumatera Utara</p>
        </div>
    </header>
    <!--------------------------------------------------------Bagian Isi Konten----------------------------------------------------------------------------------->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Jl Merdeka no 22 Kayu Jati
                        <br />
                        Kecamatan Panyabungan, Kabupaten Mandailing Natal, Sumatera Utara
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="lead mb-0">
                        Klinik <?php echo e(env('APP_NAME')); ?> dibangun sejak tahun 2002 yang berada di Kecamatan Panyabungan,
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Powered by &copy; Klinik <?php echo e(env('APP_NAME')); ?> 2023</small></div>
    </div>
    <!-- Portfolio Modals-->
